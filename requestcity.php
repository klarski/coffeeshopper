...
<title>
Request a city for coffeeshopper.co
</title>
...
<form id="form2" name="form2" class="wufoo topLabel page" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" novalidate
      action="https://kristenthechimp.wufoo.com/forms/m1j432to1ds4irf/#public">
  
<header id="header" class="info">
<h2>Request a city for coffeeshopper.co</h2>
<div></div>
</header>
...
<input type="hidden" id="idstamp" name="idstamp" value="upY4Mpk77wh0317TQi8eI1voCc/5EmP3XFcFFn3eweA=" />
</li>
</ul>
</form>
